...
//        Hats
        ...
        Hat doctor = new Hat("Doctor","hat2", mario);
...
//        Jobs
        ...
        Job job3 = new Job("Fixing a leaky faucet", "Repairing a dripping faucet", "Faucet repair", client3, "2023/09/15 11:30", null, true, false, false);
        jobRepository.save(job3);

        Job job4 = new Job("Replacing a damaged pipe", "Fixing a burst pipe", "Pipe replacement", client4, "2023/09/18 14:00", null, true, false, false);
        ...
        Job job8 = new Job("Bathroom renovation", "Upgrading plumbing fixtures", "Bathroom remodeling", client8, "2023/09/28 09:30", null, true, false, false);
        ...
        Job job11 = new Job("Installing a new kitchen sink", "Upgrading kitchen plumbing", "Kitchen renovation", client1, "2023/10/05 15:30", null, true, false, false);
        ...
        Job job23 = new Job("Emergency medical assistance", "Urgent medical care", "Emergency services", client15, "2023/11/15 16:45", null, true, false, false);
